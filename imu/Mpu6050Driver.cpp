...
Mpu6050Driver::Mpu6050Driver(platform::I2CProvider& i2c)
    : _i2c(i2c)
{
}

platform::Result Mpu6050Driver::init()
{
...
platform::Result Mpu6050Driver::readFifo(ImuSample* samples, size_t maxCount, size_t& outCount)
{
    outCount = 0;
    return platform::Result::Ok;
}
